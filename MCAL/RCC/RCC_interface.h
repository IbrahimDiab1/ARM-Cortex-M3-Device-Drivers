...
#define RCC_FLITF       4           /* Flash Interface */
#define RCC_CRCEN       6           /* Cyclic Redundancy Check */
#define RCC_FSMC        8           /* Flexible Static Memory Controller */
#define RCC_SDIO        10          /* Secure Digital Input/Output */
